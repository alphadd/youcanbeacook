...
class PGL_Widget_Price_Filter extends WC_Widget_Price_Filter {
		...
		echo '<form method="get" action="' . esc_attr( $form_action ) . '">
			<div class="price_slider_wrapper">
				...
				<div class="price_slider_amount">
					...
					<button type="submit" class="btn btn-primary btn-sm pull-left">'.__( 'Apply Filter', 'woocommerce' ).'</button>
					' . $fields . '
...
register_widget( 'PGL_Widget_Price_Filter' );