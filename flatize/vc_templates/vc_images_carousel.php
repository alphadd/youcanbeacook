...
?>
<div id="pgl-carousel-<?php echo $_id; ?>" class="carousel slide <?php echo $el_class; ?>" data-ride="carousel">
    ...
    <ol class="carousel-indicators">
        ...
        <li data-target="#pgl-carousel-<?php echo $_id; ?>" data-slide-to="<?php echo $i; ?>" class="<?php echo ($i==0)?"active":""; ?>"></li>
        <?php } ?>
    </ol>
    <?php } ?>
    
    <?php if(!$hide_prev_next_buttons){ ?>
    <a class="left carousel-control" href="#pgl-carousel-<?php echo $_id; ?>" data-slide="prev">
        <span class="glyphicon glyphicon-chevron-left"></span>
    </a>
    <a class="right carousel-control" href="#pgl-carousel-<?php echo $_id; ?>" data-slide="next">
